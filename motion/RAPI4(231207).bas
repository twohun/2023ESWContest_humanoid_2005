...
GOSUB All_motor_mode3     '모든 모터를 강한 상태로 유지
...
전진종종걸음_골프:
    ...
    ELSE
        보행순서 = 0
        MOVE G6D,93,  76, 146,  93, 101
        MOVE G6A,104,  76, 146,  93, 98
        MOVE G6B,100
        MOVE G6C,100
        WAIT
...
전진종종걸음_골프_1:
    MOVE G6A,95,  90, 124, 100, 104
    MOVE G6D,103,  76, 145,  93,  102
    MOVE G6B, 90
    MOVE G6C,115
    WAIT
...
전진종종걸음_골프_2:
    ...
    MOVE G6A,107,   73, 139, 103,  100
    MOVE G6D, 90,  83, 145,  85, 102
    WAIT
    ...
    IF A <> A_old THEN
전진종종걸음_골프_2_stop:
        MOVE G6D,93,  90, 124, 95, 104
        MOVE G6A,107,  76, 144,  91,  102
        MOVE G6C, 100
        MOVE G6B,100
        WAIT
        HIGHSPEED SETOFF
...
전진종종걸음_골프_4:
    MOVE G6D,95,  88, 124, 103, 104
    MOVE G6A,107,  76, 145,  93,  102
    MOVE G6C, 85
    MOVE G6B,110
    WAIT
...
전진종종걸음_골프_5:
    MOVE G6D,102,    74, 139, 103,  100
    MOVE G6A, 97,  83, 145,  85, 102
    WAIT
    'DELAY 10
...
전진종종한걸음_골프:
    ...
    MOVE G6A,95,  76, 147,  93, 102
    MOVE G6D,101,  76, 147,  93, 99
    MOVE G6B,100
    MOVE G6C,100
    WAIT
	
    MOVE G6A, 95, 90, 125, 100, 103
    MOVE G6D,103, 76, 146,  93, 101
    MOVE G6B, 90
    MOVE G6C,115
    WAIT
    
    MOVE G6A,107,   73, 140, 103, 101 '100
    MOVE G6D, 90,  83, 146,  85,  101 '102
    
    HIGHSPEED SETOFF
    
    SPEED 15
    MOVE G6D,93,  90, 125, 95, 103
    MOVE G6A,107,  76, 145,  91, 100
    MOVE G6C, 100
    MOVE G6B,100
    WAIT    
...
동심원_왼쪽으로:
    ...
    SPEED 8
    MOVE G6D,95,  91, 145,  78, 104, 100
    MOVE G6A,91,  61, 145,  108, 104, 100
    WAIT

    SPEED 12
    MOVE G6D,91,  91, 145,  78, 102, 100
    MOVE G6A,88,  61, 145,  108, 102, 100
    WAIT
...
MAIN: '라벨설정
    ...
    'ETX 4800, 38 ' 동작 멈춤 확인 송신   원래 주석 아니였음
